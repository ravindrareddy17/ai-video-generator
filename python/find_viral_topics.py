...
def select_best_topic(topics: list[dict], recent_titles: list[str] = None) -> dict:
    ...
    system_prompt = (
        ...
        "2. Major mission announcements from ANY country (NOT just SpaceX/NASA — actively seek ISRO, ESA, JAXA, CNSA, UAE Space Agency, Korean KARI)\n"
        "3. Rocket launches and landings\n"
        "4. New scientific discoveries (James Webb, exoplanets, black holes, dark matter, asteroid mining)\n"
        "5. Global space competition / Space race rivalries\n"
        ...
        "10. Evergreen educational content (Mars colonization, Dyson spheres, alien life debate)\n\n"
        "CRITICAL DIVERSITY RULE: You MUST NOT select a topic about the same entity (e.g. SpaceX, NASA, China) as the last 3 uploaded videos. Rotate between different countries, agencies, and themes. If the recent videos are all about SpaceX, you MUST pick ISRO, ESA, JAXA, or a scientific discovery instead. VARIETY IS KING for algorithm growth.\n\n"
