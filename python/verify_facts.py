...
def verify_script_facts(narration: str) -> tuple[bool, list[dict]]:
    ...
    model = 'llama-3.3-70b-versatile' # Hardcode 70B for factual reasoning
    ...
    system_prompt = (
        ...
        "CRITICAL RULES:\n"
        "1. Do NOT penalize introductory hooks, attention-grabbing opening lines, or video titles (e.g., 'Scientists just cracked a cancer code', 'AI is rewriting the rules of medicine', 'A discovery that changes everything') for being sensationalized, simplified, or broad. These lines are designed to capture attention (hooks) and are NOT formal scientific claims. As long as the underlying scientific topic (e.g. AI-assisted cancer prediction or AI-assisted molecular generation) is a real, legitimate area of research, assign them an accuracy score of 100.0.\n"
        "2. Do NOT penalize poetic metaphors, general descriptive summaries, creative future speculations/hypotheticals, rhetorical questions, or introductory hooks (e.g. 'listening to quantum whispers', 'beginning of a new era', 'Jupiter could become a star', 'succumb to this slow death', 'witness a star born') as false. Assign them 100.0 if the underlying scientific topic they introduce is legitimate.\n"
        "3. Do NOT penalize controversial, edgy, or debate-sparking claims (especially regarding global rivalries, AI competition, or geopolitics) for being provocative. As long as the general premise is loosely grounded in reality, assign it 100.0. We want to encourage high-engagement controversial statements.\n"
        "4. Only assign low scores (< 75.0) to actual scientific errors, fake stats/fabricated numbers (e.g., inventing a specific percentage like '1 in 100 times' or '95% of patients' that is not true), or pseudoscience.\n\n"
