...
def verify_script_facts(narration: str) -> tuple[bool, list[dict]]:
    ...
    system_prompt = (
        ...
        "3. Only assign low scores (< 75.0) to actual scientific errors, fake stats/fabricated numbers (e.g., inventing a specific percentage like '1 in 100 times' or '95% of patients' that is not true), or pseudoscience.\n\n"
