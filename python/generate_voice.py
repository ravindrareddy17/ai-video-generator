...
VOICE_PROFILES = {
    "deep_story": {"voice": "en-US-SteffanNeural", "rate": "+15%"},
    "energetic": {"voice": "en-US-ChristopherNeural", "rate": "+25%"},
    "casual": {"voice": "en-US-GuyNeural", "rate": "+20%"},
    "serious": {"voice": "en-US-EricNeural", "rate": "+10%"},
}
